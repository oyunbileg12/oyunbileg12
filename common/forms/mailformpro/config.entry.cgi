...
## フォームの送信先
push @mailto,'kimura@webkikaku.com';
#push @mailto,'koushin@webkikaku.com';

## 自動返信メールの差出人名
$config{'fromname'} = '株式会社　まるまる';
...
$config{'ThanksPage'} = 'https://xsvx1017813.xsrv.jp/partsCollection/thanks/';

## 設置者に届くメールの件名
$config{'subject'} = '[ %s ] エントリーフォームから';
...
$config{"ReturnSubject"} = '[ %s ] エントリーありがとうございました';
